...
applySorter isReversed sorter data =
    case sorter of
        ...
        IncOrDecWithMaybes ascending descending ->
            if isReversed then
                ascending data
            else
                descending data
...
type Sorter data
    ...
    | IncOrDecWithMaybes (List data -> List data) (List data -> List data)
...
increasingOrDecreasingBySorters ascendingCompare descendingCompare =
    IncOrDecWithMaybes (List.sortWith ascendingCompare) (List.sortWith descendingCompare)
